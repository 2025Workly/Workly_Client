...
export default function BoardWrite({ closeOnClick, onSuccessPost }: PopupProps) {
  ...
  return (
    <div className={styles.allContainer}>
      ...
      <div className={styles.contentContainer}>
        <img src="/images/close-btn.png" onClick={closeOnClick}  className={styles.closeBtnImg}></img>
