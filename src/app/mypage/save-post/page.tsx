...
export default function SavedPage() {
    ...
    const handleCategoryClick = async (category: string) => {
        ...
        try {
            const response = await axios.get(`http://localhost:5000/stored/${type}/${sub}`, {
                headers: {
    ...
    return (
        <div className={styles.savedPostAllContainer}>
            <div className={styles.container}>
                ...
                <div className={styles.categoryContainer} style={{ marginBottom: "31px" }}>
                ...
                {/* 정보 카드들 */}
                <div className={activeCategory === '단어' ? styles.infoCardContainer : styles.tipContainer}>
                    {savePost.length > 0 ? (
                        savePost.map((post) => (
                            <InfoCard
